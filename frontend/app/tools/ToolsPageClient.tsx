...
export default function ToolsPageClient({ initialTools, initialHasMore }: ToolsPageClientProps) {
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full px-4 py-3 pl-12 pr4 text-lg border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                />
